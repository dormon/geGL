...
void glDeleteSemaphoresEXT(GLsizei n,const GLuint* semaphores)const;
...
void glBufferStorageMemEXT(GLenum target,GLsizeiptr size,GLuint memory,GLuint64 offset)const;
...
void glPolygonOffsetClamp(GLfloat factor,GLfloat units,GLfloat clamp)const;
...
void glGenQueryResourceTagNV(GLsizei n,GLint* tagIds)const;
...
void glGetNamedFramebufferParameterfvAMD(GLuint framebuffer,GLenum pname,GLuint numsamples,GLuint pixelindex,GLsizei size,GLfloat* values)const;
...
GLVULKANPROCNV glGetVkProcAddrNV(const GLchar* name)const;
...
void glFramebufferSamplePositionsfvAMD(GLenum target,GLuint numsamples,GLuint pixelindex,const GLfloat* values)const;
...
void glGetUnsignedBytevEXT(GLenum pname,GLubyte* data)const;
...
void glSignalSemaphoreEXT(GLuint semaphore,GLuint numBufferBarriers,const GLuint* buffers,GLuint numTextureBarriers,const GLuint* textures,const GLenum* dstLayouts)const;
...
void glMultiDrawArraysIndirectCount(GLenum mode,const void* indirect,GLintptr drawcount,GLsizei maxdrawcount,GLsizei stride)const;
...
void glTextureStorageMem3DEXT(GLuint texture,GLsizei levels,GLenum internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLuint memory,GLuint64 offset)const;
...
void glImportMemoryWin32NameEXT(GLuint memory,GLuint64 size,GLenum handleType,const void* name)const;
...
void glImportSemaphoreWin32HandleEXT(GLuint semaphore,GLenum handleType,void* handle)const;
...
void glSemaphoreParameterui64vEXT(GLuint semaphore,GLenum pname,const GLuint64* params)const;
...
GLint glQueryResourceNV(GLenum queryType,GLint tagId,GLuint bufSize,GLint* buffer)const;
...
void glRenderGpuMaskNV(GLbitfield mask)const;
...
void glMulticastBufferSubDataNV(GLbitfield gpuMask,GLuint buffer,GLintptr offset,GLsizeiptr size,const GLvoid* data)const;
...
void glMultiDrawArraysIndirectCountARB(GLenum mode,const void* indirect,GLintptr drawcount,GLsizei maxdrawcount,GLsizei stride)const;
void glTextureStorageMem1DEXT(GLuint texture,GLsizei levels,GLenum internalFormat,GLsizei width,GLuint memory,GLuint64 offset)const;
...
GLboolean glIsMemoryObjectEXT(GLuint memoryObject)const;
...
void glGetMemoryObjectParameterivEXT(GLuint memoryObject,GLenum pname,GLint* params)const;
...
void glSignalVkFenceNV(GLuint64 vkFence)const;
...
void glMulticastGetQueryObjecti64vNV(GLuint gpu,GLuint id,GLenum pname,GLint64* params)const;
...
void glMulticastGetQueryObjectuivNV(GLuint gpu,GLuint id,GLenum pname,GLuint* params)const;
...
void glImportSemaphoreFdEXT(GLuint semaphore,GLenum handleType,GLint fd)const;
...
void glDeleteMemoryObjectsEXT(GLsizei n,const GLuint* memoryObjects)const;
...
void glMulticastGetQueryObjectivNV(GLuint gpu,GLuint id,GLenum pname,GLint* params)const;
...
void glTexStorageMem1DEXT(GLenum target,GLsizei levels,GLenum internalFormat,GLsizei width,GLuint memory,GLuint64 offset)const;
...
void glMulticastBlitFramebufferNV(GLuint srcGpu,GLuint dstGpu,GLint srcX0,GLint srcY0,GLint srcX1,GLint srcY1,GLint dstX0,GLint dstY0,GLint dstX1,GLint dstY1,GLbitfield mask,GLenum filter)const;
...
void glMaxShaderCompilerThreadsKHR(GLuint count)const;
...
void glGetUnsignedBytei_vEXT(GLenum target,GLuint index,GLubyte* data)const;
...
void glTexStorageMem3DEXT(GLenum target,GLsizei levels,GLenum internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLuint memory,GLuint64 offset)const;
...
void glTextureStorageMem3DMultisampleEXT(GLuint texture,GLsizei samples,GLenum internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLboolean fixedSampleLocations,GLuint memory,GLuint64 offset)const;
...
void glWaitSemaphoreEXT(GLuint semaphore,GLuint numBufferBarriers,const GLuint* buffers,GLuint numTextureBarriers,const GLuint* textures,const GLenum* srcLayouts)const;
...
void glBufferStorageExternalEXT(GLenum target,GLintptr offset,GLsizeiptr size,GLeglClientBufferEXT clientBuffer,GLbitfield flags)const;
...
void glLGPUCopyImageSubDataNVX(GLuint sourceGpu,GLbitfield destinationGpuMask,GLuint srcName,GLenum srcTarget,GLint srcLevel,GLint srcX,GLint srxY,GLint srcZ,GLuint dstName,GLenum dstTarget,GLint dstLevel,GLint dstX,GLint dstY,GLint dstZ,GLsizei width,GLsizei height,GLsizei depth)const;
...
void glMulticastGetQueryObjectui64vNV(GLuint gpu,GLuint id,GLenum pname,GLuint64* params)const;
...
void glImportSemaphoreWin32NameEXT(GLuint semaphore,GLenum handleType,const void* name)const;
...
void glSpecializeShaderARB(GLuint shader,const GLchar* pEntryPoint,GLuint numSpecializationConstants,const GLuint* pConstantIndex,const GLuint* pConstantValue)const;
...
void glDrawVkImageNV(GLuint64 vkImage,GLuint sampler,GLfloat x0,GLfloat y0,GLfloat x1,GLfloat y1,GLfloat z,GLfloat s0,GLfloat t0,GLfloat s1,GLfloat t1)const;
...
void glMemoryObjectParameterivEXT(GLuint memoryObject,GLenum pname,const GLint* params)const;
void glGenSemaphoresEXT(GLsizei n,GLuint* semaphores)const;
...
void glMulticastBarrierNV()const;
...
void glSignalVkSemaphoreNV(GLuint64 vkSemaphore)const;
...
GLboolean glAcquireKeyedMutexWin32EXT(GLuint memory,GLuint64 key,GLuint timeout)const;
...
void glWaitVkSemaphoreNV(GLuint64 vkSemaphore)const;
...
void glTextureStorageMem2DEXT(GLuint texture,GLsizei levels,GLenum internalFormat,GLsizei width,GLsizei height,GLuint memory,GLuint64 offset)const;
...
void glMultiDrawElementsIndirectCount(GLenum mode,GLenum type,const void* indirect,GLintptr drawcount,GLsizei maxdrawcount,GLsizei stride)const;
...
void glMulticastCopyBufferSubDataNV(GLuint readGpu,GLbitfield writeGpuMask,GLuint readBuffer,GLuint writeBuffer,GLintptr readOffset,GLintptr writeOffset,GLsizeiptr size)const;
...
void glNamedBufferStorageMemEXT(GLuint buffer,GLsizeiptr size,GLuint memory,GLuint64 offset)const;
...
void glSpecializeShader(GLuint shader,const GLchar* pEntryPoint,GLuint numSpecializationConstants,const GLuint* pConstantIndex,const GLuint* pConstantValue)const;
...
void glTexStorageMem3DMultisampleEXT(GLenum target,GLsizei samples,GLenum internalFormat,GLsizei width,GLsizei height,GLsizei depth,GLboolean fixedSampleLocations,GLuint memory,GLuint64 offset)const;
...
void glMulticastFramebufferSampleLocationsfvNV(GLuint gpu,GLuint framebuffer,GLuint start,GLsizei count,const GLfloat* v)const;
...
void glMulticastWaitSyncNV(GLuint signalGpu,GLbitfield waitGpuMask)const;
...
void glTexStorageMem2DMultisampleEXT(GLenum target,GLsizei samples,GLenum internalFormat,GLsizei width,GLsizei height,GLboolean fixedSampleLocations,GLuint memory,GLuint64 offset)const;
...
GLboolean glIsSemaphoreEXT(GLuint semaphore)const;
...
void glMulticastCopyImageSubDataNV(GLuint srcGpu,GLbitfield dstGpuMask,GLuint srcName,GLenum srcTarget,GLint srcLevel,GLint srcX,GLint srcY,GLint srcZ,GLuint dstName,GLenum dstTarget,GLint dstLevel,GLint dstX,GLint dstY,GLint dstZ,GLsizei srcWidth,GLsizei srcHeight,GLsizei srcDepth)const;
...
void glAlphaToCoverageDitherControlNV(GLenum mode)const;
...
void glTextureStorageMem2DMultisampleEXT(GLuint texture,GLsizei samples,GLenum internalFormat,GLsizei width,GLsizei height,GLboolean fixedSampleLocations,GLuint memory,GLuint64 offset)const;
...
void glGetFramebufferParameterfvAMD(GLenum target,GLenum pname,GLuint numsamples,GLuint pixelindex,GLsizei size,GLfloat* values)const;
...
void glGetSemaphoreParameterui64vEXT(GLuint semaphore,GLenum pname,GLuint64* params)const;
...
void glDeleteQueryResourceTagNV(GLsizei n,const GLint* tagIds)const;
...
void glTexStorageMem2DEXT(GLenum target,GLsizei levels,GLenum internalFormat,GLsizei width,GLsizei height,GLuint memory,GLuint64 offset)const;
...
void glNamedBufferStorageExternalEXT(GLuint buffer,GLintptr offset,GLsizeiptr size,GLeglClientBufferEXT clientBuffer,GLbitfield flags)const;
...
void glMultiDrawElementsIndirectCountARB(GLenum mode,GLenum type,const void* indirect,GLintptr drawcount,GLsizei maxdrawcount,GLsizei stride)const;
...
void glLGPUNamedBufferSubDataNVX(GLbitfield gpuMask,GLuint buffer,GLintptr offset,GLsizeiptr size,const void* data)const;
...
void glNamedFramebufferSamplePositionsfvAMD(GLuint framebuffer,GLuint numsamples,GLuint pixelindex,const GLfloat* values)const;
...
void glQueryResourceTagNV(GLint tagId,const GLchar* tagString)const;
...
GLboolean glReleaseKeyedMutexWin32EXT(GLuint memory,GLuint64 key)const;
